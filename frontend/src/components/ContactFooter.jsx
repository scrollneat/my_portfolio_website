      ...
      >
          <div className="w-full max-w-2xl">
              ...
              <div className="mb-12 border-l-4 border-primary pl-6">
                  <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-mono text-primary font-bold tracking-tight mb-2 break-words">CONTACT_INTERFACE</h1>
              ...
              <div className="mt-24 space-y-12">
                  <div className="flex items-center gap-4">
                      ...
                      <h2 className="font-mono text-sm tracking-[0.3em] text-primary uppercase">Direct_Access_Nodes</h2>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      ...
                      <motion.div 
                        whileHover={{ y: -5 }}
                        className="p-6 bg-surface-container-low border border-outline-variant rounded-xl flex flex-col items-center text-center gap-4 transition-all hover:border-primary/50 group"
                      >
                          <span className="material-symbols-outlined text-primary group-hover:animate-pulse text-3xl">location_on</span>
                          <div className="space-y-1">
                              <p className="font-mono text-[10px] text-primary tracking-widest uppercase">Location</p>
                              <p className="font-body text-xs text-on-surface leading-relaxed">
                                  40, Thiru vi ka street, M.G.R Nagar,<br />
                      ...
                      <motion.div 
                        whileHover={{ y: -5 }}
                        className="p-6 bg-surface-container-low border border-primary/40 rounded-xl flex flex-col items-center text-center gap-4 transition-all hover:border-primary group shadow-[0_0_20px_rgba(var(--primary),0.1)]"
                      >
                          <span className="material-symbols-outlined text-primary group-hover:rotate-12 transition-transform text-4xl">call</span>
                          <div className="space-y-1">
                              <p className="font-mono text-[10px] text-primary tracking-widest uppercase">For Call</p>
                              <a href="tel:+918838449971" className="font-body text-lg text-on-surface font-bold hover:text-primary transition-colors tracking-tight">
                                  +91 8838449971
                              </a>
                          </div>
                      </motion.div>
                      ...
                      <motion.div 
                        whileHover={{ y: -5 }}
                        className="p-6 bg-surface-container-low border border-outline-variant rounded-xl flex flex-col items-center text-center gap-4 transition-all hover:border-primary/50 group overflow-hidden"
                      >
                          <span className="material-symbols-outlined text-primary group-hover:-translate-y-1 transition-transform text-3xl">mail</span>
                          <div className="space-y-1 w-full px-2">
                              <p className="font-mono text-[10px] text-primary tracking-widest uppercase">By Mail</p>
                              <a href="mailto:barathiselvanofficial@gmail.com" className="font-body text-[13px] text-on-surface font-bold hover:text-primary transition-colors tracking-tight break-words block">
                  ...
                  <div className="flex flex-wrap justify-center gap-4">
                      <a 
                        ...
                        className="flex-1 min-w-[140px] p-4 bg-zinc-900/50 border border-zinc-800 rounded-lg flex items-center justify-center gap-3 hover:border-[#0077B5] hover:bg-[#0077B5]/5 transition-all group"
                      >
                          <svg className="w-5 h-5 text-zinc-500 group-hover:text-[#0077B5] transition-colors" fill="currentColor" viewBox="0 0 24 24">
                              <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.761 0 5-2.239 5-5v-14c0-2.761-2.239-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                          </svg>
                          <span className="font-mono text-[10px] tracking-widest text-zinc-500 group-hover:text-white uppercase">LinkedIn</span>
                      </a>

                      <a 
                        href="https://github.com/scrollneat/" 
                        target="_blank" rel="noopener noreferrer"
                        className="flex-1 min-w-[140px] p-4 bg-zinc-900/50 border border-zinc-800 rounded-lg flex items-center justify-center gap-3 hover:border-white hover:bg-white/5 transition-all group"
                      >
                          ...
                          <span className="font-mono text-[10px] tracking-widest text-zinc-500 group-hover:text-white uppercase">GitHub</span>
                      </a>

                      <a 
                        href="https://www.instagram.com/barathi_selvan?igsh=MWd1aGxjbXF5OG0ybw==" 
                        target="_blank" rel="noopener noreferrer"
                        className="flex-1 min-w-[140px] p-4 bg-zinc-900/50 border border-zinc-800 rounded-lg flex items-center justify-center gap-3 hover:border-[#E4405F] hover:bg-[#E4405F]/5 transition-all group"
                      >
                          <svg className="w-5 h-5 text-zinc-500 group-hover:text-[#E4405F] transition-colors" fill="currentColor" viewBox="0 0 24 24">
                          ...
                          <span className="font-mono text-[10px] tracking-widest text-zinc-500 group-hover:text-[#E4405F] uppercase">Instagram</span>
                      </a>
                  </div>
              </div>
          </div>
