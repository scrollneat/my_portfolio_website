            ...
            <div className="max-w-7xl mx-auto w-full px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-16 relative z-10">
                ...
                >
                    ...
                    <div className="relative w-full py-12 lg:py-0 lg:pt-2 flex flex-col items-center lg:items-start">
                        ...
                        >
                            ...
                            >
                                {[
                                    { label: 'SQL', icon: <img src="/assets/sql_logo.png" alt="SQL" className="w-full h-full object-contain filter brightness-110" />, color: '#00A36C' },
                                    { label: 'Python', icon: <img src="/assets/python_logo.png" alt="Python" className="w-full h-full object-contain filter brightness-110" />, color: '#A855F7' },
                                    { label: 'PySpark', icon: <img src="/assets/spark_logo.png" alt="Spark" className="w-full h-full object-contain filter brightness-110" />, color: '#E25A1C' },
                                    { label: 'Snowflake', icon: <img src="/assets/snowflake_logo.png" alt="Snowflake" className="w-full h-full object-contain filter brightness-110" />, color: '#29B5E8' },
                                    { label: 'Databricks', icon: <img src="/assets/databricks_logo.png" alt="Databricks" className="w-full h-full object-contain filter brightness-110" />, color: '#FF3621' },
                                ].concat([
                                    { label: 'SQL', icon: <img src="/assets/sql_logo.png" alt="SQL" className="w-full h-full object-contain filter brightness-110" />, color: '#00A36C' },
                                    { label: 'Python', icon: <img src="/assets/python_logo.png" alt="Python" className="w-full h-full object-contain filter brightness-110" />, color: '#A855F7' },
                                    { label: 'PySpark', icon: <img src="/assets/spark_logo.png" alt="Spark" className="w-full h-full object-contain filter brightness-110" />, color: '#E25A1C' },
                ...
                >
                    <div className="relative w-full aspect-square max-w-[500px] transform-gpu [transform:rotateX(35deg)_rotateZ(-45deg)] scale-[0.8] md:scale-100">
                        ...
                        >
                            <div className="w-16 h-16 bg-white/5 rounded-full flex items-center justify-center mb-2 group-hover:bg-[#00A36C]/20 transition-colors p-3">
                                <img src="/assets/sql_logo.png" alt="SQL" className="w-full h-full object-contain" />
                            </div>
                        ...
                        >
                            <div className="w-16 h-16 bg-white/5 rounded-full flex items-center justify-center mb-2 group-hover:bg-[#3776AB]/20 transition-colors p-2">
                                <img src="/assets/python_logo.png" alt="Python" className="w-full h-full object-contain filter brightness-110" />
                            </div>
                        ...
                        >
                            <div className="w-16 h-16 bg-white/5 rounded-full flex items-center justify-center mb-2 group-hover:bg-[#E25A1C]/20 transition-colors p-3">
                                <img src="/assets/spark_logo.png" alt="Spark" className="w-full h-full object-contain filter brightness-125" />
                            </div>
                        ...
                        >
                            <div className="w-16 h-16 bg-white/5 rounded-full flex items-center justify-center mb-2 group-hover:bg-[#29B5E8]/20 transition-colors p-3">
                                <img src="/assets/snowflake_logo.png" alt="Snowflake" className="w-full h-full object-contain filter brightness-125" />
                            </div>
